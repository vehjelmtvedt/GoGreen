...
public class RequestsTest {
    ...
    public void testSendFriendRequestValid() {
        ...
        assertEquals(true, Requests.sendFriendRequest(testUser.getUsername(), testUser2.getUsername()));
    }
    ...
    public void testAcceptFriendRequest() {
        ...
        assertEquals(true, Requests.acceptFriendRequest(testUser.getUsername(), testUser2.getUsername()));
    }
    ...
    public void testRejectFriendRequest() {
        ...
        assertEquals(true, Requests.rejectFriendRequest(testUser.getUsername(), testUser2.getUsername()));
    }
