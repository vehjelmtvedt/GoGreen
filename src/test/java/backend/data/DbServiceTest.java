...
public class DbServiceTest {
    ...
    public void testGetTopUsers() {
        List<User> topUsers = dbService.getTopUsers(10);
        ...
        List<Double> expectedScores = Arrays.stream(CO2TestScores).boxed() // Convert CO2TestScores Array to Stream<Double>
                .sorted(Comparator.reverseOrder()) // Sort in DESC order
                .limit(10) // Take only 10 entries
