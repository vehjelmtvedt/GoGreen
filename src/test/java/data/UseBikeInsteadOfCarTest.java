...
public class UseBikeInsteadOfCarTest {
    ...
    public void testCalculateDailyCarbonEmissions() {
        ...
        assertEquals((int) CarbonCalculator.smallCarEmissions(20), (int) travel1.calculateDailyCarbonEmissions(user));
        user.setCarType("medium");
        assertEquals((int) CarbonCalculator.mediumCarEmissions(20), (int) travel1.calculateDailyCarbonEmissions(user));
        user.setCarType("large");
        assertEquals((int) CarbonCalculator.largeCarEmissions(20), (int) travel1.calculateDailyCarbonEmissions(user));
        user.setCarType("I don't own a car");
        assertEquals(0, (int) travel1.calculateDailyCarbonEmissions(user));
    }
